<?
	...
	if (isset($_GET["action"])) {
		...
		if ($_GET["action"]=="getForm") {
			...
			echo "<table align='center'  border=0><tr><td><img src='images/logo_cercle.png' style='margin-top:2px;'></td><td>";
			echo "<button type='submit' value='1' name='yopola' class='nextStep'>Ajouter un cercle</button>";
			echo "<button type='submit' value='2' name='yopola' class='nextStep'>Modifier un cercle</button>";
			echo "<button type='submit' value='3' name='yopola' class='nextStep'>Supprimer un cercle</button>";
			echo "</td></tr><tr><td><img src='images/logo_role.png' style='margin-top:2px;'></td><td>";
			echo "<button type='submit' value='4' name='yopola' class='nextStep'>Ajouter un rôle</button>";
			echo "<button type='submit' value='5' name='yopola' class='nextStep'>Modifier un rôle</button>";
			echo "<button type='submit' value='6' name='yopola' class='nextStep'>Supprimer un rôle</button>";
			echo "</td></tr><tr><td><img src='images/logo_politique.png' style='margin-top:2px;'></td><td>";
			echo "<button type='submit' value='7' name='yopola' class='nextStep'>Ajouter une politique</button>";
			echo "<button type='submit' value='8' name='yopola' class='nextStep'>Modifier une politique</button>";
			echo "<button type='submit' value='9' name='yopola' class='nextStep'>Supprimer une politique</button>";
			echo "</td></tr></table>";	
?>
<script>
...
<?
	...
	if (isset($_POST["action"])) {
		...
		switch ($_POST["action"]) {
			case "saveGouv" :
				include ("form_gouvernance/action_save_gouv.php");
			break;
			case "createTab":
...
<div id="new_action" title="Ajouter une action">
		<table align='center' border='0'><tr><td><img src='images/logo_cercle.png' style='margin-top:2px;'></td><td>
		...
		<button name='new_action' class='new_action' value='2'>Modifier un cercle</button>
  		...
  		</td></tr><tr><td><img src='images/logo_role.png' style='margin-top:2px;'></td><td>
		...
		<button  name='new_action' class='new_action' value='5'>Modifier un rôle</button>
  		...
  		</td></tr><tr><td><img src='images/logo_politique.png' style='margin-top:2px;'></td><td>
