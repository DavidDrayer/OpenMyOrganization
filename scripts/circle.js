	...
	function refreshProjects(role) {
		...
		$("#project_role_"+role).load("/class/widget/wg_circlebrowser/onglet_projets.php?action=refresh&role="+role,codeProjects);
		
		
	}
	function refreshProject(project) {
	$("#proj_"+project).load("/class/widget/wg_circlebrowser/onglet_projets.php?action=refresh&project="+project,codeProjects);
	}
	...
	function refreshMembers(circle) {
		...
		$("#ui-tabs-1").load("/class/widget/wg_circlebrowser/refresh.php?refresh=member&circle="+circle);
	}

	function refreshChecklist(circle) {
		$("#tabs-4").load("/class/widget/wg_circlebrowser/refresh.php?refresh=checklist&circle="+circle);
	}
	
	function refreshMetrics(circle) {
		$("#tabs-5").load("/class/widget/wg_circlebrowser/refresh.php?refresh=metrics&circle="+circle);
	}
