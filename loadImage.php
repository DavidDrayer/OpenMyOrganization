...
if(isset($_POST))
{
    ...
    $ThumbPrefix            = "mid/"; //Normal thumb Prefix
    $DestinationDirectory   = 'images/user/'; //specify upload directory ends with / (slash)
    ...
    if (isset($_POST["newImageName"])) {
    	$NewImageName = $_POST["newImageName"].'.'.$ImageExt;
    } else {
    ...
    if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
    {
        ...
        */
        ...
        echo '<img src="images/user/'.$ThumbPrefix.$NewImageName.'" alt="Thumbnail">';
