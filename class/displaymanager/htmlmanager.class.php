<?php
	...
	class HTMLManager implements GenericGraphicManager
	{
		...
		public function getBrowser($object) {
				...
				if(isset($object[0])){
					switch (get_class($object[0]))			
					{
						...
						default:
							...
							echo "Aucun browser pour les tableaux de classe ".get_class($object[0]);
					}
				}
				if(isset($object[1])){
			...
			{
				case "ui\\Page" : 
					// Retourne l'élément wg_pageBrowser
					return new \widget\wg_pageBrowser($object);
					break;					
				case "holacracy\\Organisation" : 
					// Retourne l'élément wg_organisationsBrowser
					return new \widget\wg_organisationBrowser($object);
				...
				case "holacracy\\Meeting" : 
					// Retourne l'élément wg_circleBrowser
					return new \widget\wg_meetingBrowser($object);
					break;
				
				case "holacracy\\Role" : 
					// Retourne l'élément wg_roleBrowser
					return new \widget\wg_roleBrowser($object);
					break;
				case "holacracy\\User" : 
					// Retourne l'élément wg_roleBrowser
					return new \widget\wg_userBrowser($object);
					break;
				default:
					// Aucun browser défini pour cet objet
