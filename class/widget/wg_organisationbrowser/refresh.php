...
<?php
	...
	if (isset($_GET["refresh"])) {
		switch ($_GET["refresh"]) {
			case "metrics" :
				$org=$_SESSION["currentManager"]->loadOrganisation($_GET["organisation"]);
				$metrics=$_SESSION["currentUser"]->getMetrics(false, $org);
				include_once("../wg_circlebrowser/onglet_metrics.php");
				break;
			case "checklist" :
				$org=$_SESSION["currentManager"]->loadOrganisation($_GET["organisation"]);
				$checklist=$_SESSION["currentUser"]->getChecklists(false, $org);
				include_once("../wg_circlebrowser/onglet_checklist.php");
				break;
			case "roleContent" :
